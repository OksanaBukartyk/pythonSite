...
This example dispatches to an API app under "/api", an admins app
under "/admins", and an app that serves frontend files for all other
requests::
...
API and admins apps would each be deployed with a separate WSGI server,
